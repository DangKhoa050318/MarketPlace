...
import com.training.marketplace.enums.StockStatus;
...
public record StockLowEvent(
    ...
    public StockLowEvent {
        ...
        variantId = Objects.requireNonNull(variantId, "variantId is required");
    ...
    public static StockLowEvent create(
        ...
        String identity = "%s:%d:%d"
                .formatted(source.eventId(), warehouseId, variantId);
