...
public class ProductQuestionController {
    ...
    public ApiResponse<QuestionResponse> createQuestion(
        ...
        return ApiResponse.success("Question submitted successfully", response);
    }
    ...
    private Long resolveOptionalUserId(Authentication authentication) {
        ...
        try {
            return userService.getByIdentifier(auth.getName()).getId();
